...
use WellRESTed\ErrorHandling\TextErrorHandler;

/**
 * @covers WellRESTed\ErrorHandling\TextErrorHandler
 * @uses WellRESTed\ErrorHandling\ErrorHandler
 * @uses WellRESTed\Message\Stream
 */
class TextErrorHandlerTest extends \PHPUnit_Framework_TestCase
{
    private $body;
    private $request;
    private $response;
